y = [1373 6443;1458 10256;1524 10466];
x = [100 200 300];
bar(x,y);  
...
ylabel('Transmission Overhead (number of times)','FontWeight','bold','FontSize',18);	
l = legend('Decision','Non-Decision',2);
set(l,'FontWeight','bold','FontSize',15);
set(gca,'FontSize',16); 
title('Transmission Overhead','FontWeight','bold','FontSize',20);
ylim([0 15000]);
